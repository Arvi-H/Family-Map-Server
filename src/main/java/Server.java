...
public class Server {
    ...
    // Using the HttpServer class, you can easily make a Java program that can receive incoming HTTP requests, and respond with appropriate HTTP responses.
    // HttpServer is the class that actually implements the HTTP network protocol
    // The "server" field contains the HttpServer instance for this program, which is initialized in the "run" method below.
    ...
    private void run(String portNumber) {
        ...
        try {
            ...
            // Rather than calling "new" directly, we instead create the object by calling the HttpServer.create static factory method.
