...
/**
 * This is a mock client used for pass off of the CS240 Family Map Network.Server project.
...
public class ServerTest {
    ...
    public void testValidNewRegister(TestInfo testInfo) {
        ...
        try {
            ...
            assertEquals(SHEILA.getUsername(), result.getUsername(), "username from Network.Server does not match the requested username");
    ...
    public void testPersistence(TestInfo testInfo) {
        ...
        //inside the Family Map Network.Server Program assignment listed on the Assignments tab on canvas.
        scanner.nextLine();
        try {
            //We are creating a JsonReader from the LoadData.json file
            JsonReader jsonReader = new JsonReader(new FileReader("passoffFiles/LoadData.json"));
